...
const commandMap: { [key: number]: Command } = {
    // 程序控制相关
    1: {
        name: "NewLine",
        description: "回车，空行",
    ...
    1000: { name: "SlEvCmdCodeGetSystemTimeServer", description: "获取服务器系统时间", documentation: "**SlEvCmdCodeGetSystemTimeServer()**\n\n获取系统时间 - 服务器。" },
    1400: { name: "SlEvCmdCodeGetEnemyID", description: "获取敌人 ID", documentation: "**SlEvCmdCodeGetEnemyID()**\n\n获取当前敌人的 ID。" },
    1500: { name: "SlEvCmdCodeGetPropModelID", description: "获取具模 ID", documentation: "**SlEvCmdCodeGetPropModelID()**\n\n获取当前物品的模型 ID。" },
    1900: { name: "SlEvCmdCodeEventObjZoneChangeOld", description: "事件对象区域变更 (旧版本)", documentation: "**SlEvCmdCodeEventObjZoneChangeOld()**\n\n事件对象区域变更的旧版本。" },
    1901: { name: "SlEvCmdCodeEventObjSetEnemySpawns", description: "设置事件对象敌人刷新", documentation: "**SlEvCmdCodeEventObjSetEnemySpawns()**\n\n设置事件对象的敌人刷新。" },
    1902: { name: "SlEvCmdCodeEventObjSetSpawnTiming", description: "设置事件对象刷新时间", documentation: "**SlEvCmdCodeEventObjSetSpawnTiming()**\n\n设置事件对象的刷新时间。" },
    1903: { name: "SlEvCmdCodeEventObjSetSpawnWeather", description: "设置事件象刷新天气", documentation: "**SlEvCmdCodeEventObjSetSpawnWeather()**\n\n设置事件对象的刷新天气。" },
    1904: { name: "SlEvCmdCodeEventObjChangeRoomByTarget", description: "通过目标改变事件对象房间", documentation: "**SlEvCmdCodeEventObjChangeRoomByTarget()**\n\n通过目标改变事件对象的房间。" },
    1905: { name: "SlEvCmdCodeEventObjChangeRoomByGateOld", description: "通过传送门改变事件对象房间 (旧版本)", documentation: "**SlEvCmdCodeEventObjChangeRoomByGateOld()**\n\n通过传送门改变事件对象房间的旧版本。" },
    1906: { name: "SlEvCmdCodeEventObjZoneChange", description: "事件对象区域变更", documentation: "**SlEvCmdCodeEventObjZoneChange()**\n\n事件对象区域变更。" },
    1907: { name: "SlEvCmdCodeEventObjChangeRoomByGate", description: "通过传送门改变事件对象房间", documentation: "**SlEvCmdCodeEventObjChangeRoomByGate()**\n\n通过传送门改变事件对象房间。" },
    // 平行世界相关
    3000: { name: "SlEvCmdCodeParallelWorldCheckRoomExist", description: "检查房间是否在", documentation: "**SlEvCmdCodeParallelWorldCheckRoomExist()**\n\n检查指定房间是否存在。" },
    3001: { name: "SlEvCmdCodeParallelWorldCreateRoom", description: "创建房间", documentation: "**SlEvCmdCodeParallelWorldCreateRoom()**\n\n创建一个新的房间。" },
    3002: { name: "SlEvCmdCodeParallelWorldMoveToRoom", description: "移动到房间", documentation: "**SlEvCmdCodeParallelWorldMoveToRoom()**\n\n移动到指定的房间。" },
    3003: { name: "SlEvCmdCodeParallelWorldAmIPartyMaster", description: "我是否是队长", documentation: "**SlEvCmdCodeParallelWorldAmIPartyMaster()**\n\n检查我是否是队伍的队长。" },
    3004: { name: "SlEvCmdCodeParallelWorldGetPartysRoomID", description: "获取队伍的房间 ID", documentation: "**SlEvCmdCodeParallelWorldGetPartysRoomID()**\n\n获取当前队伍的房间 ID。" },

    10000: { name: "PropName", description: "PropName", documentation: "**PropName**\n\n获取属性名称。" },
    10100: { name: "NPCName", description: "NPC的名称", documentation: "**NPCName()**\n\n获取 NPC 的名称。" },
    10200: { name: "QuestStop", description: "QuestStop", documentation: "**QuestStop()**\n\n停止任务。" },
    10201: { name: "QuestState", description: "QuestState", documentation: "**QuestState()**\n\n获取任务状态。" },
    10202: { name: "QuestReadData", description: "QuestReadData", documentation: "**QuestReadData()**\n\n读取任务数据。" },
    10203: { name: "QuestStart", description: "QuestStart", documentation: "**QuestStart()**\n\n开始任务。" },
    10204: { name: "QuestContext", description: "QuestContext", documentation: "**QuestContext()**\n\n获取任务上下文。" },
    10205: { name: "QuestNewLine", description: "QuestNewLine", documentation: "**QuestNewLine()**\n\n添加任务新行。" },
    10206: { name: "QuestString", description: "QuestString", documentation: "**QuestString()**\n\n获取任务字符串。" },
    10207: { name: "QuestValue", description: "QuestValue", documentation: "**QuestValue()**\n\n获取任务值。" },
    10400: { name: "GetLocalTime", description: "取本地时间", documentation: "**GetLocalTime()**\n\n获取本地时间。" },
};
...
export function activate(context: vscode.ExtensionContext) {
    ...
    context.subscriptions.push(
        vscode.languages.registerDocumentSemanticTokensProvider(
            'sl',
            slSemanticTokensProvider,
            slSemanticTokensProvider.getLegend()
        )
    );

    // 注册悬停提供者
    context.subscriptions.push(
        vscode.languages.registerHoverProvider({ scheme: 'file', language: 'sl' }, {
...
class SLSemanticTokensProvider implements vscode.DocumentSemanticTokensProvider {
    private getCommandRegex(): RegExp {
    ...
    getLegend(): vscode.SemanticTokensLegend {
        const tokenTypes: string[] = ['comment', 'function'];
        const tokenModifiers: string[] = []; // 显式声明为 string[] 类型
